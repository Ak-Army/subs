...
type Config struct {
	...
	ExtraInfoReplacements        []*Replacements      `yaml:"extra_info_replacements"`
	ReleasegroupInfoReplacements []*Replacements      `yaml:"releasegroup_info_replacements"`
	SeriesnameReplacements       []*Replacements      `yaml:"seriesname_replacements"`
	FilenameBlacklist            []*FilenameBlacklist `yaml:"filename_blacklist"`
	...
	DecompSuffix                 string               `yaml:"decomp_suffix"`
}
